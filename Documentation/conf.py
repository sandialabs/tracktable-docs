...
# CMake variant it is located here: tracktable-docs/Documentation/cmake_build
...
env_copy["TRACKTABLE_VERSION"] = tracktable_version
subprocess.call(['doxygen readthedocs/Doxyfile-readthedocs'], shell=True, env=env_copy)
...
copyright = u"""Copyright (c) 2014-2023 National Technology and Engineering Solutions of Sandia, LLC. Under the terms of Contract DE-NA0003525 with National Technology and Engineering Solutions of Sandia, LLC, the U.S. Government retains certain rights in this software."""

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
#
tracktable_version_list= tracktable_version.split('.')
# The short X.Y version.
version = tracktable_version_list[0] + '.' + tracktable_version_list[1]
# The full version, including alpha/beta/rc tags.
release = tracktable_version
...
AUTHORS = u'Andy Wilson and Danny Rintoul and Chris Valicka and Ben Newton and Phil Baxley and Kat Ward and Rick Vinyard and Michael Scoggin and Michael Fadem and Geoff Danielson'
latex_documents = [
...
version_string = u"Tracktable "+ tracktable_version + " Documentation"
man_pages = [
    ('index', 'tracktable', version_string,
     [AUTHORS], 1)
]
...
epub_copyright = u'2014-2023, National Technology and Engineering Solutions of Sandia, Inc.'
